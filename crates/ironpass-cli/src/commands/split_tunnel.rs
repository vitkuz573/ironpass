...
pub async fn handle(
    ...
    match action {
        ...
        crate::args::SplitTunnelAction::Add {
            ...
            let node_id = parse_optional_uuid(&node)?;
            let rule = client
                .add_split_tunnel_rule(map_target(target), value, map_action(action), node_id)
                .await?;
...
fn map_target(
    ...
    match target {
        crate::args::SplitTunnelTargetArg::Domain => {
            ironpass_core::models::SplitTunnelTarget::Domain
        }
...
fn map_action(
    ...
    match action {
        crate::args::SplitTunnelActionArg::Direct => {
            ironpass_core::models::SplitTunnelAction::Direct
        }
